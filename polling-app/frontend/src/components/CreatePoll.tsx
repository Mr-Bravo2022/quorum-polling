...
export default function CreatePoll({ onCreated }: Props) {
  ...
  return (
    <form className="card" onSubmit={handleSubmit}>
      ...
      <div className="field">
        {/* Label associated with the input via htmlFor/id, so screen readers
            announce "Question" when the field is focused. */}
      ...
      {/* The option inputs are a named group; each carries its own label. */}
      <div className="field" role="group" aria-labelledby="options-label">
        <span className="label" id="options-label">Options</span>
